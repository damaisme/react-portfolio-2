    ...
    return (
        <div id="honors" className="mt-4 text-white">
            ...
            <div className="flex flex-col md:flex-row mt-4 gap-5">
                <HonorCard name="Top 10 SELEKNAS ASEAN Skills Competition ITNSA 202" issued="KEMENAKER RI" desc="Linux Server, Windows Server, Linux Routing, Cisco Troubleshooting, Cisco Network Analysis, Network and System Programmabillity, Containerized Service." />
